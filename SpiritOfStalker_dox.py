# -*- coding: utf-8 -*-
#
# STALKER by Spirit Of Stalker
# Discord https://discord.gg/gxtrRGGpWZ
# 

__version__ = 2.1 # by dos argenta
...
def emailSpam():
	try:
		email = input("[#][STALKER-DOX][SETool][Your email:~$ ")
		password = input("[#][STALKER-DOX][SETool][Your password:~$ ")
		print(wait+" Sign in ...")
		...
		try:
			...
			sys.exit()
		spoof_mail = input("[#][STALKER][SETool][From:~$ ")
		target_email = input("[#][STALKER][SETool][To:~$ ")
		nb = input("[#][STALKER][SETool][NB Email to send:~$ ")
		nb = int(nb)

		objet = input("[#][STALKER][SETool][Objet:~$ ")
...
def bssidFinder():
	bssid = input("[#][STALKER][Lookup][MAC/BSSID:~$ ")
	# clear()
...
def Search118218():
	...
	name = input("\n[#][STALKER][Lookup][Nom Prenom:~$ ")
	city = input("\n[#][STALKER][Lookup][Ville/Departement:~$")
...
def check_email_exist():
	email_address = input("[STALKER][#][Email:~$ ")
...
def google():
	nom = input("\n[#][STALKER][Lookup][name, first name, city (...):~$ ")
...
Date: %s \033[92m
Time: %s \033[92m
Coded by \033[95mDOS-ARGENTA\033[92m 
Version: [%s\033[92m]--[\033[96mStable\033[92m]
Internet: [%s\033[92m]
                                  
                   Welcome to SpiritOfStalker ...
...
try:
	while True:
		...
		if choix.lower() == 'h':
			...
			sys.exit(information+" \033[92mJoin Discord Group for feedback:\033[96m https://discord.gg/gxtrRGGpWZ\033[0m")
		elif choix == '1':
			clear()
			menu()
			print(lookupOption)
